            ...
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                <nav class="menu menu--iris">
                    <ul class="nav navbar-nav menu__list">
                        ...
                        <li class="menu__item"><a href="{{route('payment')}}">PayPal</a></li>
...
<div id="availability-agileits">
    <div class="col-md-12 book-form-left-w3layouts">
        <a href="{{route('Room_index_frontend2')}}" target="_blank"><h2>ROOM RESERVATION</h2></a>
    </div>
    ...
    @foreach($lsRoom as $room)
        @foreach($room->RoomImage as $item)
            <div class="col-md-3 gallery-grid gallery1">
                <a href="{{route('Roome_detail',$room->id)}}" {{asset($item->image)}}><img src="{{asset($item->image)}}"
