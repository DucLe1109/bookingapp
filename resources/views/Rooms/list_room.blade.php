        ...
        <div class="row">
            <div class="col-md-3">
                <input class="form-control"
                       ...
                       name="check_in" value="{{$check_in}}" min="{{date('Y-m-d')}}">
            </div>
            <div class="col-md-3">
                <input class="form-control"
                       style="background-color: white;display: inline"
                       type="date" placeholder="Price"
                       name="check_out" value="{{$check_out}}" min="{{date('Y-m-d')}}">
            </div>
            <div class="col-md-3">
                <input class="form-control"
                       style="background-color: white;display: inline"
                                                    ...
                                                    @foreach($lsRoom as $room)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{route('BookRoom',$room->id)}}" target="_blank">
                                                                    <img src="{{asset('upload/Book-now.png')}}" style="height: 60px;width: 60px;">
                                                                </a>
